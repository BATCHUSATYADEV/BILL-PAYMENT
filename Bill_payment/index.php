...
<html lang="en">
   ...
   <body>
      <section class="mt-3">
         ...
         <h3 class="text-center" style="color:green"> SRI SATYAMANI TRADESH </h3>
         <p class="text-center"> 535145,GOWRINAGAR ,SKOTA ,VZM DIST</p>
         <div class="row">
            ...
            <div  class="col-md-7  mt-4" style="background-color:#f5f5f5;">
               <div class="p-4" id="printMe">
                ...
                <center>
            <button onclick="printDiv('printMe')" style="padding-left: 50px;padding-right: 50px;padding-top: 10px;padding-bottom: 10px" class="btn btn-primary">Print</button>
      </center><br><br>
            </div>
